        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'left' }}>
          ...
          <div style={{ marginBottom: '50px' }}>
            ...
            <div style={{ display: 'grid', gap: '20px' }}>
              <FeatureCard>
                <h3 style={{ fontSize: '20px', marginTop: '0' }}>Teams with too much manual admin and follow-up work</h3>
                <p style={{ margin: '0', fontSize: '16px' }}>You're spending 10+ hours per week on repetitive data entry, status updates, or chasing approvals.</p>
              </FeatureCard>
              <FeatureCard>
                <h3 style={{ fontSize: '20px', marginTop: '0' }}>Businesses losing leads/customers in handoffs</h3>
                <p style={{ margin: '0', fontSize: '16px' }}>Work falls through the cracks between sales → delivery, support → engineering, or intake → fulfillment.</p>
              </FeatureCard>
              <FeatureCard>
                <h3 style={{ fontSize: '20px', marginTop: '0' }}>Owners who want "less chaos, more throughput"</h3>
                <p style={{ margin: '0', fontSize: '16px' }}>You know automation would help, but don't know where to start or what's realistic given your budget and team size.</p>
              </FeatureCard>
            </div>
          </div>
          ...
          {/* What you receive */}
          <div style={{ marginBottom: '50px', padding: '30px', backgroundColor: currentTheme.surface, borderRadius: currentTheme.borderRadius }}>
            <h2 style={{ fontSize: '28px', color: currentTheme.text, marginTop: '0', marginBottom: '25px' }}>What you receive (1-page format)</h2>
          ...
          {/* Example outline */}
          <div style={{ marginBottom: '50px' }}>
            <h2 style={{ fontSize: '28px', color: currentTheme.text, marginBottom: '25px' }}>Example outline (public-safe)</h2>
            <div style={{ padding: '30px', backgroundColor: currentTheme.background, borderRadius: currentTheme.borderRadius, border: `1px solid ${currentTheme.border}` }}>
              <div style={{ marginBottom: '30px' }}>
                <h3 style={{ fontSize: '20px', color: currentTheme.primary, marginTop: '0', marginBottom: '15px' }}>Current Workflow Map</h3>
                <p style={{ fontSize: '16px', color: currentTheme.textSecondary, margin: '0 0 10px 0' }}>
                  Intake → Fulfillment → Billing → Reporting
                </p>
                <p style={{ fontSize: '15px', color: currentTheme.textSecondary, margin: '0', fontStyle: 'italic' }}>
                  Visual diagram showing handoff points, tools used, and current cycle time
                </p>
              </div>

              <div style={{ marginBottom: '30px' }}>
                <h3 style={{ fontSize: '20px', color: currentTheme.primary, marginTop: '0', marginBottom: '15px' }}>Bottlenecks + Failure Points</h3>
                <ul style={{ fontSize: '16px', color: currentTheme.textSecondary, paddingLeft: '20px', margin: '0' }}>
              ...
              <div style={{ marginBottom: '30px' }}>
                <h3 style={{ fontSize: '20px', color: currentTheme.primary, marginTop: '0', marginBottom: '15px' }}>Top 3 Opportunities</h3>
                <div style={{ overflowX: 'auto' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '15px' }}>
                    <thead>
                      <tr style={{ borderBottom: `2px solid ${currentTheme.border}` }}>
                        <th style={{ textAlign: 'left', padding: '12px 8px', color: currentTheme.text }}>Opportunity</th>
                        <th style={{ textAlign: 'left', padding: '12px 8px', color: currentTheme.text }}>Effort</th>
                        <th style={{ textAlign: 'left', padding: '12px 8px', color: currentTheme.text }}>Risk</th>
                        <th style={{ textAlign: 'left', padding: '12px 8px', color: currentTheme.text }}>Est. Impact</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr style={{ borderBottom: `1px solid ${currentTheme.border}` }}>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Auto-sync intake → CRM</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Low (2 days)</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Low</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>3hrs/week saved</td>
                      </tr>
                      <tr style={{ borderBottom: `1px solid ${currentTheme.border}` }}>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Status notification workflow</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Medium (4 days)</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Low</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>2hrs/week + better CX</td>
                      </tr>
                      <tr>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Invoice auto-generation</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Medium (5 days)</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>Medium</td>
                        <td style={{ padding: '12px 8px', color: currentTheme.textSecondary }}>1.5hrs/week + fewer errors</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div style={{ marginBottom: '30px' }}>
                <h3 style={{ fontSize: '20px', color: currentTheme.primary, marginTop: '0', marginBottom: '15px' }}>Recommended First Build (MVP)</h3>
                <p style={{ fontSize: '16px', color: currentTheme.textSecondary, margin: '0 0 10px 0' }}>
                  <strong>Start with:</strong> Auto-sync intake → CRM
                </p>
                <p style={{ fontSize: '16px', color: currentTheme.textSecondary, margin: '0' }}>
                  <strong>Why:</strong> Low effort, low risk, immediate time savings, and sets foundation for status workflow in Phase 2
                </p>
              </div>

              <div>
                <h3 style={{ fontSize: '20px', color: currentTheme.primary, marginTop: '0', marginBottom: '15px' }}>Phase Plan + Owners</h3>
                <div style={{ fontSize: '16px', color: currentTheme.textSecondary, lineHeight: '1.8' }}>
          ...
          <div style={{ padding: '40px', backgroundColor: currentTheme.background, borderRadius: currentTheme.borderRadius, border: `2px solid ${currentTheme.primary}`, textAlign: 'center' }}>
            <h2 style={{ fontSize: '32px', color: currentTheme.text, marginTop: '0', marginBottom: '20px' }}>Ready to see your automation opportunities?</h2>
