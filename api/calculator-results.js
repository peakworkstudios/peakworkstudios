          ...
          <div style="padding:0 24px;">
            ...
            ${breakdownRows ? `
              ...
              <div style="background:#fffbeb;border-left:4px solid #f59e0b;padding:20px;margin-bottom:32px;border-radius:8px;">
                ...
                <p style="font-size:14px;color:#78350f;line-height:1.7;margin:0;">Most agencies see their biggest savings from automating data entry, reporting, and follow-ups — these three alone typically save <strong>12-18 hours per week</strong> for the team.</p>
              </div>
            ` : ''}

            <!-- Social Proof -->
            <div style="background:#f0fdf4;border:1px solid #86efac;padding:20px;margin-bottom:32px;border-radius:8px;">
              <div style="font-size:14px;font-weight:700;color:#166534;margin-bottom:12px;">✅ What Other Agencies Report:</div>
